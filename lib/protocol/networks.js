...
main.magic = 0xd9c4bef9; // b4 changed c4 for bitcoin edu
...
main.pow = {
  ...
  targetTimespan: 1 * 24 * 60 * 60, // one day
  ...
  retargetInterval: 144,  // 1 * 24 * 60 * 60 / (10 * 60)
...
main.block = {
  /**
   * Height at which bip34 (v2 blocks) was activated.
   * Used for avoiding bip30 checks (unique tx ids) since v2 includes height in coinbase.
   */

   /* v2 blocks start from block 17 (first block after genesis)
    * Actually v2 from block 1 but due to bug in getCoinbaseHeight must
    * not be <= 16.
    */
  ...
  bip34hash: '000000006B6BFE9D1DBC8916414C88CD39F0C5CDE736A7B99FBA51097F2F6D47',

  /**
   * Height at which bip65, OP_CHECKLOCKTIMEVERIFY, was activated.
   */

  bip65height: 1, // available from start

  /**
   * Hash of the block that activated bip65.
   */

  bip65hash: '0000000024be97ed7bf3c4e512d29d0f7bd233a396d817477fb7bd4131bdd875',

  /**
   * Height at which bip66, Strict DER signatures, was activated.
   */

  bip66height: 1, // strict from start

  /**
   * Hash of the block that activated bip66.
   */

  bip66hash: '0000000024be97ed7bf3c4e512d29d0f7bd233a396d817477fb7bd4131bdd875',
...
/*
 * Note for Bitcoin Edu: segwit is forced permanently active in
 * blockchain/chain.js
 */
main.deployments = {
  csv: {
 ...
 *
 * Testnet not configured for Bitcoin Edu
 *
 */
 ...
 * Regtest
 *
 * Regtest not configured for Bitcoin Edu
 *
 */
